_values = [
	...
	# text font
	'roboto', 'aileronsemibold', 'dejavu', 'exo2bold', 'exo2semibold', 'kelsonsans','monoid', 'mozillavr', 'sourcecodepro',
...
# text (prevent conflict with window.top..)
values.up = 'top'
values.middle = 'center'
values.down = 'bottom'
...
for color of _colors
	values[color] = '#' + _colors[color]
